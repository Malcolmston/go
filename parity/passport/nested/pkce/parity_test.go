// Package parity drives the upstream (pkce-challenge) and Go
// (github.com/malcolmston/passport/pkce) runners over an identical set of
...
// passport@0.7.0 and its strategies; this directory scores the nested pkce
// package against its own upstream, the npm implementation of RFC 7636 Proof Key
// for Code Exchange.
//
// Run with:
//
//	GOWORK=off go test ./parity/passport/nested/pkce/
package parity
...
var nodeDeps = []string{"pkce-challenge"}
