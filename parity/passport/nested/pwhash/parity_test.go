// Package parity drives the upstream (pbkdf2) and Go
// (github.com/malcolmston/passport/pwhash) runners over an identical set of
...
// passport@0.7.0 and its strategies; this directory scores the nested pwhash
// package against its own upstream, the npm implementation of PBKDF2 (RFC 2898),
// the algorithm the package implements.
//
// Run with:
//
//	GOWORK=off go test ./parity/passport/nested/pwhash/
package parity
