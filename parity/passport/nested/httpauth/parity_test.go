// Package parity drives the upstream (http-auth-utils) and Go
// (github.com/malcolmston/passport/httpauth) runners over an identical set of
...
// passport@0.7.0 and its strategies; this directory scores the nested httpauth
// package against its own upstream, the npm package that parses and builds HTTP
// Authorization and WWW-Authenticate headers.
//
// Run with:
//
//	GOWORK=off go test ./parity/passport/nested/httpauth/
package parity
...
var nodeDeps = []string{"http-auth-utils"}
