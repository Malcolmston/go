// Package parity drives the upstream (npm qs) and Go
// (github.com/malcolmston/express/qs) runners over an identical set of cases and
// compares their answers. Upstream is the oracle: nothing here hand-writes an
// expectation.
//
// Run with:
//
//	cd parity/express/nested/qs && GOWORK=off go test .
//
