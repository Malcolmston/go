// Package parity drives the upstream (cookie-signature@1.2.2) and Go
// (github.com/malcolmston/express/cookiesignature) runners over an identical set of
...
const (
	...
	library = "express/cookiesignature"
	// npmPackage is the upstream npm package that acts as the oracle.
	npmPackage = "cookie-signature"
	// goImport is the Go package the runner exercises.
	goImport = "github.com/malcolmston/express/cookiesignature"
)
