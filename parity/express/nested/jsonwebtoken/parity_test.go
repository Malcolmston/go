// Package parity drives the upstream (jsonwebtoken@9.0.3) and Go
// (github.com/malcolmston/express/jsonwebtoken) runners over an identical set of
...
const (
	...
	goImport = "github.com/malcolmston/express/jsonwebtoken"
)
